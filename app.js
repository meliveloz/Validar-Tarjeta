do { 
  var targetNumber = prompt('Ingresa los números de tu tarjeta'); 
} // Hacer prompt mientras targetNumber se encuentre vacio.
while (targetNumber === ''); 
var isValidCard = function(numbers) {
  ...
  var sum = 0; // contador .
  for (var j = 0; j < array3.length; j++) { // creo un for para ir sumando los elementos de mi array3
    sum += (parseInt(array3[j])); // voy sumando los elementos de mi array3
  }
